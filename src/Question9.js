...
const Question9 = () => {
    ...
    const question = "9. Which review of an algorithm happens after implementation?";
    const options = [
    ...
    return (
        <div>
            ...
            <div className="nav-buttons">
				<Link to="/question8" className="nav-button">← Back to Question 8</Link>
                <Link to="/question10" className="nav-button">Next Question →</Link>
